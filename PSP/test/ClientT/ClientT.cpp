...
//		std::cout << "1 - Подключение по имени сервера" << endl << "2 - Подключение по позывному" << endl;
//		//cin >> connectionType;
//		//
//		connectionType = 1;
//		//
...
//			std::cout << "Введите позывной сервера: ";
//			std::cin >> call;
//
//			SOCKET SocketUDP;
//			int optval = 1;
...
//			all.sin_addr.s_addr = inet_addr("127.0.0.1"); //172.20.10.255
...
//
//		printf_s("\n ---------- ---------- ---------- ---------- \n");
//		std::cout << endl << "1 - Rand" << endl << "2 - Time" << endl << "3 - Echo" << endl;
//		std::cin >> cCall;
//		switch (cCall) {
//		case 1:
//			strcpy_s(Call, "Rand");
...
//							std::cout << "Сервер завершил соединение:\n" << obuf;
//
//							break;
//						}
//						else
//							std::cout << "Полученное сообщение:\n" << obuf;
//
//						rcv = true;
//					}
//				}
...
//			std::cout << "Время: %lf сек.: " << (double)(FinishTime - StartTime) / CLOCKS_PER_SEC;
//
//
//		}
