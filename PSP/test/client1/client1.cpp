...
int _tmain(int argc, _TCHAR* argv[]) {
	...
	try {
		...
		if (connectionType == 1) {
			...
			all.sin_addr.s_addr = inet_addr(" 192.168.107.255"); //172.20.10.15
		...
		/*if ((lobuf = send(SocketTCP, ibuf, strlen(ibuf) + 1, NULL)) == SOCKET_ERROR)
		...
		*/
		...
		//					cout<<"Сервер завершил соединение:"<< obuf<<endl;
		//					break;
		//				}
		//				else
		//					cout << "Полученное сообщение: " << obuf<<endl;
		//					
		//				rcv = true;
		//			}
		//		}
		...
		//	cout<<"Время: "<<(double)(FinishTime - StartTime) / CLOCKS_PER_SEC<<" c.\n";
