...
public class AvsPrintTable extends TagSupport {
...
//region упрощенная версия вывода параметров переданных в тег
...
//
//@SuppressWarnings("serial")
//public class Information extends TagSupport {
//
//    private String nameTable;
//    private String nameDB;
//
...
//            out.println("<p>"+nameTable+nameDB+"</p>");
//        } catch (IOException e) {
//            throw new RuntimeException(e);
//        }
//        return SKIP_BODY;
